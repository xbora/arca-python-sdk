...
if __name__ == "__main__":
    # Replace with your actual API key from https://arca.fyi/api-keys
    ...
    try:
        ...
        print(f"\nError: {e}")
        print("\nNote: Make sure to replace 'your-api-key-here' with your actual API key from https://arca.fyi/api-keys")
