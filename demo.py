...
def demo_get_all_skills():
    ...
    print('# {')
    print('#   "success": true,')
    print('#   "userId": "user_01...",')
    print('#   "skills": [')
    print('#     {"tableName": "favorites", "skill": "...", "type": "vector", "success": true},')
    print('#     {"tableName": "meals", "skill": "...", "type": "table", "success": true}')
    print('#   ],')
    print('#   "tableSkillCount": 10,')
    print('#   "vectorSkillCount": 2')
    print('# }')
    print('\nprint(f"Total: {len(all_skills[\'skills\'])} skills")')
    print('print(f"Tables: {all_skills[\'tableSkillCount\']}, Vectors: {all_skills[\'vectorSkillCount\']}")')
    print('\n# Filter by type:')
    print('table_skills = [s for s in all_skills[\'skills\'] if s[\'type\'] == \'table\']')
